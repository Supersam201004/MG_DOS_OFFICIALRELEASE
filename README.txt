...
V0.0.3: Bug fixed: Typing anything other than 'type' in flipacoin.exe would exit the file.
V0.1.0: Official Release! BIG UPDATE:
	-Intro To I.R.I.S(Intelligent Response Information System)
	-Added 'time' function to I.R.I.S and main menu.
V0.1.1: Added Reset Command, To Reset System And/Or Profile' + Minor Fixes:
	-Changed Help Menu To Support New Systems
	-Changed Help Menu To Show Capital Letters At Start Of Description Of Command.
sorry for not updating changelog

V0.1.5: MAJOR UPDATE!!:
	-Added Sounds! Added beeping sounds for different events in the script!
